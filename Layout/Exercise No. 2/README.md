...
<p align="justify"> 
El objetivo de éste ejercio era asignar dos estilos diferentes en el color, la fuente, border radius y box shadow sobre las características sobre los elementos de una página web e importar un estilo u otro en el fichero de estilos principal. 
</p>
...
<p align="justify">
Para poder visualizar el Ejercicio es necesario moverse a la carpeta <em>Exercise No. 2</em> y ahí, copiar la ruta que va a ser visualizada: <em>/home/vanessa/Practicing projects/Master-Front-End-XX/Layout/Exercise No. 2/index.html<em>. Para poder visualizar <em>styles-II.css</em>, pegue la importación del estilo comentada en el archivo <a href="./styles/main.css">main.css</a> 
</p> 

### DEMOSTRACIÓN VISUAL

![alt text](<Theme A.png>)

![alt text](<Theme B.png>)